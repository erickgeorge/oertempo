                ...
                <div class="search-box">
                    <form method="get" action="{{ route('search') }}">
                        <div class="form-group">
                            <input type="search" name="search-field" placeholder="What do you want to learn?"
                                value="{{ $sanitized_search_text }}" required>
                ...
                @foreach ($category as $category)
                    <div class="topic-block col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <div class="clearfix">
                                <div class="pull-left">
                                    <div class="lectures">{{ $categoryCounts[$category->id] }} Contents</div>
                                </div>
                ...
                @foreach ($course as $item)
                    <div class="cource-block col-lg-4 col-md-6 col-sm-12"
                        ...
                        <div class="inner-box"
                            ...
                            <div class="image">
                                @php
                                    $extension = pathinfo($item->attachement, PATHINFO_EXTENSION);
                                @endphp


                                <a href="{{ route('coursedesc', $item->id) }}">
                                    @if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif']))
                                        <img src="{{ asset('/attachments/' . $item->attachement) }}" alt="Image Preview"
