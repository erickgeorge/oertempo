    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                @if (session('successPop'))
                    <script>
                        alert('{{ session('successPop') }}');
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image d-flex justify-content-center align-items-center"
                        style="background-image: url('{{ asset('image458.png') }}'); background-position:center;">
                        <img src="{{ asset('OERCentre.png') }}" class="img-fluid" style="margin-top: 250px;">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="{{ route('createAccount') }}">
                                @csrf
