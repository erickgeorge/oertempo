    ...
    <div class="page-wrapper">
        ...
        <header class="main-header header-style-one">
                ...
                <div class="auto-container">
                    <div class="clearfix">
                        ...
                        <div class="pull-left logo-box">
                            <div class="logo"><a href="/"><img src="{{ asset('oeR.svg') }}" width="400px"
                                        alt="" title="oer logo"></a></div>
                        </div>
            ...
            <div class="mobile-menu">
                ...
                <nav class="menu-box">
                    <div class="nav-logo"><a href="/"><img src="{{ asset('oeR.svg') }}" width="200px"
                                alt="" title=""></a></div>
                                ...
                                <div class="footer-column col-lg-5 col-md-6 col-sm-12">
                                    <div class="footer-widget links-widget">
                                        ...
                                        <ul class="links-widget">
                                            <li><a target="_blank" href="#">Afficiates</a></li>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                    <div class="footer-widget links-widget">
                                        <h4>Resource</h4>
                                        <ul class="links-widget">
                                            <li><a target="_blank" href="http://journals.udsm.ac.tz/">Journals</a>
                                            </li>
                                            <li><a target="_blank" href="http://196.44.162.10:8080/xmlui/">Research
                                                    Repository</a></li>
                                            <li><a target="_blank"
                                                    href="https://www.udsm.ac.tz/web/index.php/institutes/library">Library
                                                    Services</a></li>
                                            <li><a target="_blank" href="http://alumni.udsm.ac.tz/">Alumni</a></li>
                                            <li><a target="_blank"
                                                    href="https://www.udsm.ac.tz/web/index.php/bureaus/qab">QAB</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                                    <div class="footer-widget links-widget">
                                        <h4>Quick Links</h4>
                                        <ul class="links-widget">
                                            <li><a target="_blank" href="#">Undergraduate Prospectus</a></li>
                                            <li><a target="_blank" href="#">Postgraduate prospectus</a></li>
                                            <li><a target="_blank" href="#">Forms and downloads</a></li>
                                            <li><a target="_blank" href="#">Variour speeches</a></li>
                                            <li><a target="_blank" href="#">List of academic advisors</a></li>
                                            <li><a target="_blank" href="#">Almanac</a></li>
                                        </ul>
                                    </div>
                                </div>
